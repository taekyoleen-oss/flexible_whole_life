...
그래프 편집 규칙: 1칸 = 기준보험금 10%, 직전 변경점부터 지난 연수만큼 이동하며 그 칸 수만큼 직전 연도들이 매년 한 칸씩 계단식으로 오르내림(50세 3칸 ↑ = 47·48·49세), 축하금 = 해당 연령 보험금의 10%(여러 나이 가능). 기준보험금은 1천만원 단위. 저해지 = 납입기간 중 환급금 30%·보험료 20% 인하.
