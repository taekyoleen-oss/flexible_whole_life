...
export const PRESET_INFO: Record<PresetId, { boundary?: keyof InfoApplied; checkLabel?: string; rationale: string }> = {
  level: { rationale: "보장 금액을 바꾸지 않는 기준선입니다. 다른 프리셋과 보험료·환급금을 비교하는 출발점으로 씁니다." },
  child: {
    boundary: "child", checkLabel: "자녀정보 반영",
  ...
  debt: {
    boundary: "debt", checkLabel: "부채정보 반영",
  ...
  retire: {
    boundary: "retire", checkLabel: "은퇴시기",
  ...
  group: {
    boundary: "group", checkLabel: "단체보험 반영",
